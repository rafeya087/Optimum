...
<main role="main">
  ...
  <section class="panel">
    ...
    <div class="form-group">
      <label>Credit</label>
      <p class="form-control-static"><?php echo $row["credit"]; ?></p>
    </div>
    <div class="form-group">
      <label>Debt</label>
      <p class="form-control-static"><?php echo $row["debt"]; ?></p>
    </div>
    <div class="form-group">
      <form method="GET" action="index.php">
        <label>Pay Ammount</label>
        <input type="text" name="pay" placeholder="Enter positive number"> <input class="btn btn-outline-warning" type="submit" value="Submit">
      </form>

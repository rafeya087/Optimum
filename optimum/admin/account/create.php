...
$name = $designation = $credit = $debt = "";
$name_err = $designation_err = $credit_err = $debt_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_debt)){
        $debt_err = "Please enter the debt amount.";     
    ...
    if(empty($name_err) && empty($designation_err) && empty($credit_err) && empty($debt_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO account (name, designation, credit, debt) VALUES (?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssss", $param_name, $param_designation, $param_credit,  $param_debt);
          ...
          <div class="page-header">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($designation_err)) ? 'has-error' : ''; ?>">
                            ...
                            <textarea name="designation" class="form-control"><?php echo $designation; ?></textarea>
                        ...
                        <div class="form-group <?php echo (!empty($debt_err)) ? 'has-error' : ''; ?>">
                            <label>Debt</label>
                            <input type="text" name="debt" class="form-control" value="<?php echo $debt; ?>">

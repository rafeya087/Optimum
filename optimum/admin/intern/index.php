...
<main role="main">
  ...
  <section class="panel">
    <div class="page-header clearfix">
      <h2 class="pull-left">Interns Details</h2>
      <a href="create.php" class="btn btn-success pull-right">Add New Intern</a>
    </div>
    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='delete1.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><i class='fa fa-trash' aria-hidden='true'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
